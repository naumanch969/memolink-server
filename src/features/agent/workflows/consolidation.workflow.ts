...
export class CognitiveConsolidationWorkflow implements IAgentWorkflow {
    ...
    async execute(task: IAgentTaskDocument): Promise<AgentWorkflowResult> {
        ...
        try {
            ...
            const currentPersona = await agentService.getPersona(userId);
...
export const entityConsolidationWorkflow = new EntityConsolidationWorkflow();
export const cognitiveConsolidationWorkflow = new CognitiveConsolidationWorkflow();
